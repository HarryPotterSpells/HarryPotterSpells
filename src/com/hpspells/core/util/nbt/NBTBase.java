 ...
 * @author DPOH-VAR
 */
// HPS modifications: change static values class to SVPBypass
public abstract class NBTBase {
    ...
    static {
        try {
            methodRead = SVPBypass.getMethodByTypeTypes(class_NBTBase, void.class, java.io.DataInput.class);
            if(methodRead==null) {
                useInt = true;
                methodRead = SVPBypass.getMethodByTypeTypes(class_NBTBase, void.class, java.io.DataInput.class, int.class);
            }
            methodWrite = SVPBypass.getMethodByTypeTypes(class_NBTBase, void.class, java.io.DataOutput.class);
