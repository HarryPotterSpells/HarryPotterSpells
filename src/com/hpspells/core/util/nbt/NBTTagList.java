 ...
 * @author DPOH-VAR
 */
// HPS modifications: replaced static values class, removed getRandom function
public class NBTTagList extends NBTBase implements Iterable<NBTBase> {
    private static Class clazz = SVPBypass.getCurrentNMSClass("NBTTagList");
    private static Field fieldList;
    private static Field fieldType;

    static {
        try {
            fieldList = SVPBypass.getFieldByType(clazz,List.class);
            fieldType = SVPBypass.getFieldByType(clazz,byte.class);
