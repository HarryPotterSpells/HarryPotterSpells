...
@HCommand(name="teach", description="Teaches a player a spell", usage="/teach <spell> [player|me]")
public class Teach implements CommandExecutor {

	@Override
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		if (args.length > 2 || args.length == 0) {
			HPS.PM.dependantMessagingWarn(sender, "The correct usage is /teach <spell> [player | me].");
			return true;
		}
